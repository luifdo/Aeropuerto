...
public class AirportDtos {
    public record AirportCreateRequest(String Code, String Name, String name) implements Serializable {}
    public record AirportUpdateRequest(String Code, String Name, String name) implements Serializable {}
